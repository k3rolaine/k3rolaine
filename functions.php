...
/**
 * Converte datas entre os padr�es ISO e brasileiro
...
function dateConvert($date)
{
    if ( ! strstr( $date, '/' ) )
    {
        // $date est� no formato ISO (yyyy-mm-dd) e deve ser convertida
        // para dd/mm/yyyy
    ...
    {
        // $date est� no formato brasileiro e deve ser convertida para ISO
