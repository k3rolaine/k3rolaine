...
<body>
    ...
    <div class="video-container container">
        <video src="archives/videos/portal3.mp4" muted autoplay></video>
    </div>
    ...
    <div class="about container">
        <h2>Sobre o Jogo</h2>
        <p>
            A parte para um jogador de Portal 3: Into the Nether introduz uma gama de novos personagens dinâmicos, vários novos elementos de quebra-cabeças e uma quantidade maior de desafiadoras câmaras de teste. Os jogadores explorarão áreas nunca antes vistas do Nether e reencontrarão GLaDOS junto agora de Wither, a companheira robótica com certa tendência assassina e a entidade maligna do jogo quadrado da Microsoft/Mojang juntos agora em uma inesperada parceria.
        </p>
    </div>
