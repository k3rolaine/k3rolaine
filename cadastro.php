		...
		<div class="limiter">
			<div class="container-login100">
				<div class="wrap-login100 p-b-160 p-t-50">
					<form class="login100-form validate-form" action="add.php" method="post">
								...
								<div class="wrap-input100 rs1 validate-input" data-validate="Preencha o campo corretamente">
									...
									<div class="wrap-input100 rs2 validate-input" data-validate="Preencha o campo corretamente">
										...
										<div class="wrap-input100 rs1 validate-input" data-validate="Preencha o campo corretamente">
											...
											<div class="wrap-input100 rs2 validate-input" data-validate="Preencha o campo corretamente">
												<input class="input100" type="password" name="Confirmar_Senha">
												<span class="label-input100">Confirmar Senha</span>
											</div>
												<div class="container-login100-form-btn">
													<input class="login100-form-btn"  type="submit" value="Gravar">
												</div>
